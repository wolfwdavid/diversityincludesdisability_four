...
- [x] **ENGAGE-03**: A podcast/media section renders from a typed list in site.ts (title, description, link, accessible names) and is omitted entirely while the list is empty
